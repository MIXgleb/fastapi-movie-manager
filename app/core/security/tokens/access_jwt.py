...
from app.core.security.tokens.base import BaseSyncToken
from app.core.security.tokens.base_jwt import BaseJWToken, TypeJWToken


@final
class AccessJWToken(
    BaseSyncToken[TypeJWToken, int, Payload],
    BaseJWToken[TypeJWToken],
):
    _token_context = jwt

    @override
    def create(self, payload: Payload) -> TypeJWToken:
