...
from app.core.security.token_schemas import JWTokenPayload, Payload, TokenKey
from app.core.security.tokens.base import BaseAsyncToken
from app.core.security.tokens.base_jwt import BaseJWToken

type TypeEncryptedUserID = str


class BaseRefreshJWToken(
    BaseJWToken[TypeEncryptedUserID],
):
    ...
    def _encrypt_user_id(self, user_id: int) -> TypeEncryptedUserID:
...
class RefreshJWToken(
    BaseAsyncToken[TypeEncryptedUserID, int, Payload],
    BaseRefreshJWToken,
):
    @override
    async def create(self, payload: Payload) -> TypeEncryptedUserID:
    ...
    @override
    async def delete_by_key(self, key: int) -> None:
