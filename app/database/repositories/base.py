...
class RepositoryBase[Model, Filter](ABC):
    @abstractmethod
    async def create(self, item_create: DictAny) -> Model:
        """Create a new item.
    ...
    @abstractmethod
    async def update(self, item_id: int, item_update: DictAny) -> Model | None:
